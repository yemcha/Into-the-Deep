...
var BlowFishBattle = /** @class */ (function (_super) {
    ...
    function BlowFishBattle() {
        ...
        _this.setupInvader = function (spike, blowfish) {
            spike.anchor.x = 0.5;
            spike.anchor.y = 0.5;
        ...
        _this.setupInvader2 = function (blowfish, spike) {
            blowfish.anchor.x = 0.5;
            blowfish.anchor.y = 0.5;
            //blowfish.anchor.x = 0.5;
            //blowfish.anchor.y = 0.5;
...
var GameLoader = /** @class */ (function (_super) {
    ...
    function GameLoader() {
        ...
        _this.state.add('Intro', Intro, false);
        ...
        _this.state.add('Winner', Winner, false);
...
var LevelPicker = /** @class */ (function (_super) {
    ...
    function LevelPicker() {
        ...
        _this.nextLevel = function (player, door) {
...
var LevelPicker2 = /** @class */ (function (_super) {
    ...
    LevelPicker2.prototype.create = function () {
        ...
        var player_coordinate = this.gameLoader.player_coordinate;
        this.physics.arcade.gravity.y = 250;
        this.exit_door = this.add.sprite(0, 50, 'exit_door');
        this.physics.enable(this.exit_door, Phaser.Physics.ARCADE);
        this.exit_door.body.allowGravity = false;
        this.player = this.add.sprite(player_coordinate.x, player_coordinate.y, 'mustang');
        this.physics.enable(this.player, Phaser.Physics.ARCADE);
...
var OctopusBattle = /** @class */ (function (_super) {
    ...
    function OctopusBattle() {
        ...
        _this.setupInvader = function (tentacles, octopus) {
